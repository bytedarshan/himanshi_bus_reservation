...
def book_ticket(cursor, conn):
    ...
    try:
        ...
        # Show the seat availability in a tabular format
        print("\nSeat Availability for Your Journey:".center(50, ' '))
        print("="*50)
        print(f"{'Route':<30}{'Date':<15}{'Total Seats':<15}{'Available Seats':<15}")
        print("="*50)
        print(f"{route_name:<30}{doj_date:<15}{total_seats:<15}{available_seats:<15}")
        print("="*50)
